...
public:
    ...
    void init(const char* username, const char* appid, const char* appkey, const char* platfrom_addr, const char* cheat_src, const char* lice_server_ip, bool cdn_test);
